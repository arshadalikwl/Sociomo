...
@section('content')
                            ...
                            <div class="page-caro">
                                <div class="link-item">
                                    <a class="active" href="feed.html" title="">
                                        <i class="">
                                            <svg class="feather feather-zap" stroke-linejoin="round" stroke-linecap="round"
                                ...
                                <div class="link-item">
                                    <a href="products.html" title="">
                                        <i class="">
                                            <svg clip-rule="evenodd" fill-rule="evenodd" height="22px"
                                ...
                                <div class="link-item">
                                    <a href="blog.html" title="">
                                        <i class=""><svg class="feather feather-layout" stroke-linejoin="round"
                                                ...
                                                xmlns="http://www.w3.org/2000/svg">
                                                <rect ry="2" rx="2" height="18" width="18" y="3"
                                                    x="3" />
    ...
    <section>
        <div class="gap">
            <div class="container">
                <a href="#">
                    <div class="profile-alert" id="profile-alert">
                        <div>
                            ...
                            <p>
                                Please verify your profile ID for more features. click Here
                            </p>
                            ...
                            <div class="col-lg-3">
                                <aside class="sidebar static left">
                                    <div class="widget whitish low-opacity">
                                        <img data-src="{{ asset('app-asset/images/time-clock.png') }}" alt=""
                                            class="lazy" loading="lazy">
                                        <div class="bg-image" style="background-image: url(images/resources/time-bg.jpg)">
                                        </div>
                                        <div class="date-time">
                                            <div class="realtime">
                                    ...
                                    <div class="widget">
                                        ...
                                        <ul class="prof-complete">
                                            ...
                                            <li><i class="icofont-plus-square"></i> <a href="#" title="">Add
                                                    Payment
                                    ...
                                    <div class="advertisment-box">
                                        ...
                                        <figure>
                                            <a href="#" title="Advertisment"><img
                                                    src="{{ asset('app-asset/images/resources/ad-widget2.gif') }}"
                                                    alt="" class="lazy" loading="lazy"></a>
                                        </figure>
                                    ...
                                    <div class="widget">
                                        ...
                                        <ul class="premium-course">
                                            <li>
                                                <figure>
                                                    <img data-src="{{ asset('app-asset/images/resources/course-5.jpg') }}"
                                            ...
                                            <li>
                                                <figure>
                                                    <img data-src="{{ asset('app-asset/images/resources/course-3.jpg') }}"
                                                        alt="" class="lazy" loading="lazy">
                                    ...
                                    <div class="widget">
                                        ...
                                        <ul class="recent-links">
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/recentlink-1.jpg') }}">
                                                </figure>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/recentlink-2.jpg') }}">
                                                </figure>
                                                <div class="re-links-meta">
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/recentlink-3.jpg') }}">
                                                </figure>
                                                <div class="re-links-meta">
                                                    <h6><a title="" href="#">The Ifnets over watch
                                                            scandals.</a>
                                                    </h6>
                                    ...
                                    <div class="widget web-links stick-widget">
                                        ...
                                        <p>&copy; Ifnets 2020. All Rights Reserved.</p>
                                    </div><!-- links -->
                                </aside>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="main-wraper">
                                    ...
                                    <div class="new-post">
                                        ...
                                        <ul class="upload-media">
                                            <li>
                                                <a href="#" title="">
                                                    <i><img data-src="{{ asset('app-asset/images/image.png') }}"
                                                            alt="" class="lazy" loading="lazy"></i>
                                                    <span>Photo/Video</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" title="">
                                                    <i><img data-src="{{ asset('app-asset/images/activity.png') }}"
                                                            alt="" class="lazy" loading="lazy"></i>
                                            ...
                                            <li>
                                                <a href="live-stream.html" title="">
                                                    <i><img data-src="{{ asset('app-asset/images/live-stream.png') }}"
                                                            alt="" class="lazy" loading="lazy"></i>
                                ...
                                <div class="story-card">
                                    ...
                                    <div class="story-wraper ">
                                        <img data-src="{{ asset('app-asset/images/resources/story-card5.jpg') }}"
                                            alt="" class="lazy" loading="lazy">
                                        <div class="users-dp">
                                            <img data-src="{{ asset('app-asset/images/resources/user3.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </div>
                                        <a class="add-new-stry" href="#" title=""><i
                                                class="icofont-plus"></i></a>
                                        <span>Add Your Story</span>
                                    </div>
                                    <div class="story-wraper">
                                        <img data-src="{{ asset('app-asset/images/resources/story-card.jpg') }}"
                                            alt="" class="lazy" loading="lazy">
                                        <div class="users-dp">
                                            <img data-src="{{ asset('app-asset/images/resources/user6.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </div>
                                        <span>Tamana Bhatia</span>
                                    </div>
                                    <div class="story-wraper">
                                        <img data-src="{{ asset('app-asset/images/resources/story-card2.jpg') }}"
                                            alt="" class="lazy" loading="lazy">
                                        <div class="users-dp">
                                            <img data-src="{{ asset('app-asset/images/resources/user7.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </div>
                                        <span>Emily Caros</span>
                                    </div>
                                    <div class="story-wraper">
                                        <img data-src="{{ asset('app-asset/images/resources/story-card3.jpg') }}"
                                            alt="" class="lazy" loading="lazy">
                                        <div class="users-dp">
                                            <img data-src="{{ asset('app-asset/images/resources/user8.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </div>
                                        <span>Daniel Cardos</span>
                                    </div>
                                    <div class="story-wraper">
                                        <img data-src="{{ asset('app-asset/images/resources/story-card4.jpg') }}"
                                            alt="" class="lazy" loading="lazy">
                                        <div class="users-dp">
                                            <img data-src="{{ asset('app-asset/images/resources/user4.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </div>
                                    ...
                                    <ul class="chat-rooms">
                                        <li>
                                            <div class="room-avatar">
                                                <img data-src="{{ asset('app-asset/images/resources/user2.jpg') }}"
                                                    alt="" class="lazy" loading="lazy">
                                        ...
                                        <li>
                                            <div class="room-avatar">
                                                <img data-src="{{ asset('app-asset/images/resources/user5.jpg') }}"
                                                    alt="" class="lazy" loading="lazy">
                                                <span class="status online"></span>
                                            </div>
                                    ...
                                    <div class="user-post">
                                        <div class="friend-info">
                                            ...
                                            <ul class="suggested-caro">
                                                <li>
                                                    <figure><img
                                                            data-src="{{ asset('app-asset/images/resources/speak-1.jpg') }}"
                                                            alt="" class="lazy" loading="lazy"></figure>
                                                ...
                                                <li>
                                                    <figure><img
                                                            data-src="{{ asset('app-asset/images/resources/speak-2.jpg') }}"
                                                            alt="" class="lazy" loading="lazy"></figure>
                                                ...
                                                <li>
                                                    <figure><img
                                                            data-src="{{ asset('app-asset/images/resources/speak-3.jpg') }}"
                                                            alt="" class="lazy" loading="lazy"></figure>
                                    ...
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                ...
                                                <img alt=""
                                                    src="{{ asset('app-asset/images/resources/user7.jpg') }}">
                                            </figure>
                                            <div class="friend-name">
                                                <div class="more">
                                            ...
                                            <div class="post-meta">
                                                            ...
                                                            <span title="Comments" class="Recommend">
                                                                <i>
                                                                    <svg class="feather feather-message-square"
                                                                        ...
                                                                        fill="none" viewBox="0 0 24 24" height="16"
                                                ...
                                                <div class="stat-tools">
                                                    ...
                                                    <a title="" href="monetization.html"
                                                        class="boost-post-btn">Boost Now</a>

                                                    <div class="emoji-state">
                                                        <div class="popover_wrapper">
                                                            <a class="popover_title" href="#" title=""><img
                                                                    alt=""
                                                                    src="{{ asset('app-asset/images/smiles/thumb.png') }}"></a>
                                                            <div class="popover_content">
                                                                <span><img alt=""
                                                                        src="{{ asset('app-asset/images/smiles/thumb.png') }}">
                                                                    Likes</span>
                                                                <ul class="namelist">
                                                                    <li>Jhon Doe</li>
                                                                    <li>Amara Sin</li>
                                                        ...
                                                        <div class="popover_wrapper">
                                                            <a class="popover_title" href="#" title=""><img
                                                                    alt=""
                                                                    src="{{ asset('app-asset/images/smiles/heart.png') }}"></a>
                                                            <div class="popover_content">
                                                                <span><img alt=""
                                                                        src="{{ asset('app-asset/images/smiles/heart.png') }}">
                                                                    Love</span>
                                                                <ul class="namelist">
                                                                    <li>Amara Sin</li>
                                                                    <li>Jhon Doe</li>
                                                        ...
                                                        <div class="popover_wrapper">
                                                            <a class="popover_title" href="#" title=""><img
                                                                    alt=""
                                                                    src="{{ asset('app-asset/images/smiles/smile.png') }}"></a>
                                                            <div class="popover_content">
                                                                <span><img alt=""
                                                                        src="{{ asset('app-asset/images/smiles/smile.png') }}">
                                                                    Happy</span>
                                                                <ul class="namelist">
                                                                    <li>Sarah K.</li>
                                                                    <li>Jhon Doe</li>
                                                        ...
                                                        <div class="popover_wrapper">
                                                            <a class="popover_title" href="#" title=""><img
                                                                    alt=""
                                                                    src="{{ asset('app-asset/images/smiles/weep.png') }}"></a>
                                                            <div class="popover_content">
                                                                <span><img alt=""
                                                                        src="{{ asset('app-asset/images/smiles/weep.png') }}">
                                                                    Dislike</span>
                                                                <ul class="namelist">
                                                                    <li>Danial Carbal</li>
                                                                    <li>Amara Sin</li>
                                                    ...
                                                    <div class="new-comment" style="display: none;">
                                                        ...
                                                        <div class="comments-area">
                                                            <ul>
                                                                <li>
                                                                    <figure><img alt=""
                                                                            src="{{ asset('app-asset/images/resources/user1.jpg') }}">
                                                                    </figure>
                                                                    <div class="commenter">
                                                                ...
                                                                <li>
                                                                    <figure><img alt=""
                                                                            src="{{ asset('app-asset/images/resources/user2.jpg') }}">
                                                                    </figure>
                                                                    <div class="commenter">
                                    ...
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                ...
                                                <img alt=""
                                                    src="{{ asset('app-asset/images/resources/user6.jpg') }}">
                                            </figure>
                                            <div class="friend-name">
                                                <div class="more">
                                                    <div class="more-post-optns">
                                        ...
                                        <div class="friend-info">
                                            ...
                                            <div class="post-meta">
                                                <figure class="premium-post"><img
                                                        data-src="{{ asset('app-asset/images/resources/book5.jpg') }}"
                                                        alt=""></figure>
                                                <div class="premium">
                                ...
                                <div class="main-wraper">
                                    ...
                                    <div class="videos-caro">
                                        ...
                                        <div class="item-video" data-merge="2">
                                            ...
                                            <div class="posted-user">
                                                <img data-src="{{ asset('app-asset/images/resources/user1.jpg') }}"
                                                    alt="" class="lazy" loading="lazy">
                                    ...
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                ...
                                                <img alt=""
                                                    src="{{ asset('app-asset/images/resources/user3.jpg') }}">
                                            </figure>
                                            <div class="friend-name">
                                                <div class="more">
                                                    <div class="more-post-optns">
                                            ...
                                            <div class="post-meta">
                                                <figure>
                                                    <a data-toggle="modal" data-target="#img-comt"
                                                        ...
                                                        <img data-src="{{ asset('app-asset/images/resources/study.jpg') }}"
                                                            alt="" class="lazy" loading="lazy">
                                                    </a>
                                                </figure>
                                                <a href="post-detail.html" class="post-title">Supervision as a
                                    ...
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                ...
                                                <img alt=""
                                                    src="{{ asset('app-asset/images/resources/user4.jpg') }}">
                                            </figure>
                                            <div class="friend-name">
                                                <div class="more">
                                                    <div class="more-post-optns">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                <figure>
                                                                    <a data-toggle="modal" data-target="#img-comt"
                                                                        href="images/resources/album1.jpg')}}">
                                                                        <img data-src="{{ asset('app-asset/images/resources/album1.jpg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </figure>
                                                                <figure>
                                                                    <a data-toggle="modal" data-target="#img-comt"
                                                                        href="images/resources/album2.jpg')}}"><img
                                                                            src="{{ asset('app-asset/images/resources/album2.jpg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </figure>
                                                            </div>
                                                                ...
                                                                <figure>
                                                                    <a data-toggle="modal" data-target="#img-comt"
                                                                        href="images/resources/album6.jpg')}}"><img
                                                                            src="{{ asset('app-asset/images/resources/album6.jpg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </figure>
                                                                <figure>
                                                                    <a data-toggle="modal" data-target="#img-comt"
                                                                        href="images/resources/album5.jpg')}}"><img
                                                                            src="{{ asset('app-asset/images/resources/album5.jpg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </figure>
                                                                <figure>
                                                                    <a data-toggle="modal" data-target="#img-comt"
                                                                        href="images/resources/album4.jpg')}}"><img
                                                                            src="{{ asset('app-asset/images/resources/album4.jpg') }}"
                                                                            alt="">
                                                                    </a>
                                    ...
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                ...
                                                <img alt=""
                                                    src="{{ asset('app-asset/images/resources/user5.jpg') }}">
                                            </figure>
                                            <div class="friend-name">
                                                <div class="more">
                                                    <div class="more-post-optns">
                                            ...
                                            <div class="post-meta">
                                                ...
                                                <figure>
                                                    ...
                                                    <img data-src="{{ asset('app-asset/images/resources/laptop.png') }}"
                                                        alt="" class="lazy" loading="lazy">
                                                </figure>
                                ...
                                <div class="main-wraper">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            ...
                                            <div class="post-meta">
                                                <img class="gif" src="{{ asset('app-asset/images/giphy.png') }}"
                                ...
                                <div class="main-wraper">
                                    <div class="user-post">
                                        <div class="friend-info">
                                            <figure>
                                                <img alt=""
                                                    src="{{ asset('app-asset/images/resources/sponsor.png') }}">
                                            </figure>
                                            <div class="friend-name">
                                                <div class="more">
                                                    <div class="more-post-optns">
                                            ...
                                            <div class="post-meta">
                                                <ul class="sponsored-caro">
                                                    <li>
                                                        <figure><img
                                                                data-src="{{ asset('app-asset/images/resources/sponsor-prod1.jpg') }}"
                                                                alt=""></figure>
                                                    ...
                                                    <li>
                                                        <figure><img
                                                                data-src="{{ asset('app-asset/images/resources/sponsor-prod5.jpg') }}"
                                                                alt=""></figure>
                                                        <div class="sponsor-prod-name">
                                                    ...
                                                    <li>
                                                        <figure><img
                                                                data-src="{{ asset('app-asset/images/resources/sponsor-prod4.jpg') }}"
                                                                alt=""></figure>
                                                        <div class="sponsor-prod-name">
                                                    ...
                                                    <li>
                                                        <figure><img
                                                                data-src="{{ asset('app-asset/images/resources/sponsor-prod3.jpg') }}"
                                                                alt=""></figure>
                                                        <div class="sponsor-prod-name">
                                                    ...
                                                    <li>
                                                        <figure><img
                                                                data-src="{{ asset('app-asset/images/resources/sponsor-prod2.jpg') }}"
                                                                alt=""></figure>
                                                        <div class="sponsor-prod-name">
                                ...
                                <aside class="sidebar static right">
                                    <div class="widget">
                                        ...
                                        <ul class="ak-groups">
                                            <li>
                                                <figure><img
                                                        data-src="{{ asset('app-asset/images/resources/your-group1.jpg') }}"
                                                        alt="" class="lazy" loading="lazy"></figure>
                                                <div class="your-grp">
                                                    ...
                                                    <a href="#" title=""><i
                                                        ...
                                                        <span>13</span></a>
                                                    <a href="group-feed.html" title="" class="promote">view
                                                        feed</a>
                                                </div>
                                            </li>
                                            <li>
                                                <figure><img
                                                        data-src="{{ asset('app-asset/images/resources/your-group2.jpg') }}"
                                                        alt="" class="lazy" loading="lazy"></figure>
                                                <div class="your-grp">
                                                    <h5><a href="group-detail.html" title="">E-course Group</a>
                                                    </h5>
                                                    <a href="#" title=""><i
                                                            class="icofont-bell-alt"></i>Notifilactions
                                                        <span>13</span></a>
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="sug-caro">
                                            <div class="friend-box">
                                                <figure>
                                                    <img alt=""
                                                        src="{{ asset('app-asset/images/resources/sidebar-info.jpg') }}">
                                                    <span>Members: 505K</span>
                                                </figure>
                                                <div class="frnd-meta">
                                                    <img alt=""
                                                        src="{{ asset('app-asset/images/resources/frnd-figure2.jpg') }}">
                                                    <div class="frnd-name">
                                                        <a title="" href="#">Social Research</a>
                                                        <span>@biolabest</span>

                                                    </div>
                                                    <a class="main-btn2" href="#" title="">Join
                                                        Community</a>
                                                </div>
                                            </div>
                                            <div class="friend-box">
                                                <figure>
                                                    <img alt=""
                                                        src="{{ asset('app-asset/images/resources/sidebar-info2.jpg') }}">
                                                    <span>Members: 505K</span>
                                                </figure>
                                                <div class="frnd-meta">
                                                    <img alt=""
                                                        src="{{ asset('app-asset/images/resources/frnd-figure3.jpg') }}">
                                                    <div class="frnd-name">
                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="rec-events bg-purple">
                                            ...
                                            <img alt="" src="{{ asset('app-asset/images/clock.png') }}">
                                        </div>
                                    ...
                                    <div class="widget">
                                        ...
                                        <ul class="sponsors-ad">
                                            <li>
                                                <figure><img
                                                        data-src="{{ asset('app-asset/images/resources/sponsor.jpg') }}"
                                                        alt="" class="lazy" loading="lazy"></figure>
                                            ...
                                            <li>
                                                <figure><img
                                                        data-src="{{ asset('app-asset/images/resources/sponsor2.jpg') }}"
                                                        alt="" class="lazy" loading="lazy"></figure>
                                                <div class="sponsor-meta">
                                    ...
                                    <div class="widget stick-widget">
                                        ...
                                        <ul class="followers">
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/friend-avatar.jpg') }}">
                                                </figure>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/friend-avatar2.jpg') }}">
                                                </figure>
                                                <div class="friend-meta">
                                                    <h4>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/friend-avatar3.jpg') }}">
                                                </figure>
                                                <div class="friend-meta">
                                                    <h4>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/friend-avatar4.jpg') }}">
                                                </figure>
                                                <div class="friend-meta">
                                                    <h4>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="{{ asset('app-asset/images/resources/friend-avatar5.jpg') }}">
                                                </figure>
                                                <div class="friend-meta">
                                                    <h4>
    ...
    <figure class="bottom-mockup"><img data-src="{{ asset('app-asset/images/footer.png') }}" alt=""
            class="lazy" loading="lazy"></figure>
    <div class="bottombar">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <span class="">&copy; copyright All rights reserved by Ifnets 2020</span>
                </div>
            </div>
        </div>
    </div><!-- bottombar -->
        ...
        <div class="popup">
            ...
            <div class="popup-meta">
                ...
                <div class="invitation-meta">
                    <p>
                        Enter an email address to invite a colleague or co-author to join you on Ifnets. They will
            ...
            <div class="tab-content">
                <div class="tab-pane active fade show" id="messages">
                    ...
                    <ul class="new-messages">
                        <li>
                            <figure><img data-src="{{ asset('app-asset/images/resources/user1.jpg') }}" alt=""
                                    class="lazy" loading="lazy"></figure>
                            <div class="mesg-info">
                        ...
                        <li>
                            <figure><img data-src="{{ asset('app-asset/images/resources/user2.jpg') }}" alt=""
                                    class="lazy" loading="lazy"></figure>
                            <div class="mesg-info">
                                <span>Fatima J.</span>
                                <a href="#" title="">Helo dear i wanna talk to you</a>
                        ...
                        <li>
                            <figure><img data-src="{{ asset('app-asset/images/resources/user3.jpg') }}" alt=""
                                    class="lazy" loading="lazy"></figure>
                            <div class="mesg-info">
                        ...
                        <li>
                            <figure><img data-src="{{ asset('app-asset/images/resources/user4.jpg') }}" alt=""
                                    class="lazy" loading="lazy"></figure>
                            <div class="mesg-info">
                        ...
                        <li>
                            <figure><img data-src="{{ asset('app-asset/images/resources/user5.jpg') }}" alt=""
                                    class="lazy" loading="lazy"></figure>
                            <div class="mesg-info">
                    ...
                    <form method="post" class="c-form">
                        ...
                        <div class="select-box">
                            <div class="select-box__current" tabindex="1">
                                ...
                                <img class="select-box__icon" src="{{ asset('app-asset/images/arrow-down.svg') }}"
        ...
        <div class="share-options">
            ...
            <div style="display: block;" class="social-media">
                <ul>
                    ...
                    <li><a title="" href="#" class="instagram"><i class="icofont-instagram"></i></a>
                    </li>
                    <li><a title="" href="#" class="pinterest"><i class="icofont-pinterest"></i></a>
                    </li>
                    ...
                    <li><a title="" href="#" class="behance"><i
                                class="icofont-behance-original"></i></a></li>
                </ul>
            </div>
            <div style="display: none;" class="friends-to">
                <div class="follow-men">
                    <figure><img class="mCS_img_loaded" src="{{ asset('app-asset/images/resources/user1.jpg') }}"
                            alt="" class="lazy" loading="lazy"></figure>
                ...
                <div class="follow-men">
                    <figure><img class="mCS_img_loaded" src="{{ asset('app-asset/images/resources/user2.jpg') }}"
                            alt="" class="lazy" loading="lazy"></figure>
                    <div class="follow-meta">
                ...
                <div class="follow-men">
                    <figure><img class="mCS_img_loaded" src="{{ asset('app-asset/images/resources/user3.jpg') }}"
                            alt="" class="lazy" loading="lazy"></figure>
                    <div class="follow-meta">
    ...
    <div class="chat-live">
        <a class="chat-btn" href="#" title="Start Live Chat" data-toggle="tooltip"><i
                class="icofont-facebook-messenger"></i></a>
        <span>07</span>
    </div><!-- chat button -->
    ...
    <div class="chat-box">
            ...
            <div class="tab-content">
                <div class="tab-pane active fade show " id="link1">
                    <div class="friend">
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user1.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status online"></span>
                            </figure>
                            <span>Oliver</span>
                            <i class=""><img data-src="{{ asset('app-asset/images/resources/user1.jpg') }}"
                                    alt="" class="lazy" loading="lazy"></i>
                        </a>
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user2.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status away"></span>
                            </figure>
                            <span>Amelia</span>
                        ...
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user3.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status offline"></span>
                            </figure>
                            <span>George</span>
                            <i class=""><img data-src="{{ asset('app-asset/images/resources/user3.jpg') }}"
                                    alt="" class="lazy" loading="lazy"></i>
                        </a>
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user4.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status online"></span>
                            </figure>
                            <span>Jacob</span>
                        ...
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user5.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status away"></span>
                            </figure>
                            <span>Poppy</span>
                        ...
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user6.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status online"></span>
                            </figure>
                            <span>Sophia</span>
                            <i class=""><img data-src="{{ asset('app-asset/images/resources/user6.jpg') }}"
                                    alt="" class="lazy" loading="lazy"></i>
                        </a>
                        <a href="#" title="">
                            <figure>
                                <img data-src="{{ asset('app-asset/images/resources/user7.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <span class="status away"></span>
                            </figure>
                            <span>Leo king</span>
                            <i class=""><img data-src="{{ asset('app-asset/images/resources/user7.jpg') }}"
                                    alt="" class="lazy" loading="lazy"></i>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="friend">
                        <a href="#" title="">
                            <figure class="group-chat">
                                <img data-src="{{ asset('app-asset/images/resources/user5.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <img class="two" src="{{ asset('app-asset/images/resources/user3.jpg') }}"
                                    alt="" class="lazy" loading="lazy">
                                <span class="status online"></span>
                            </figure>
                        ...
                        <a href="#" title="">
                            <figure class="group-chat">
                                <img data-src="{{ asset('app-asset/images/resources/user3.jpg') }}" alt=""
                                    class="lazy" loading="lazy">
                                <img class="two" src="{{ asset('app-asset/images/resources/user2.jpg') }}"
                                    alt="" class="lazy" loading="lazy">
                                <span class="status away"></span>
                            </figure>
        ...
        <div class="chat-card">
            <div class="chat-card-head">
                <img data-src="{{ asset('app-asset/images/resources/user13.jpg') }}" alt="" class="lazy"
                    loading="lazy">
                <h6>George Floyd</h6>
                <div class="frnd-opt">
                    <div class="more">
            ...
            <div class="chat-list">
                <ul>
                    <li class="me">
                        <div class="chat-thumb"><img
                                data-src="{{ asset('app-asset/images/resources/chatlist1.jpg') }}" alt=""
                                class="lazy" loading="lazy"></div>
                        <div class="notification-event">
                            <div class="chat-message-item">
                                <figure><img data-src="{{ asset('app-asset/images/resources/album5.jpg') }}"
                                        alt="" class="lazy" loading="lazy"></figure>
                            ...
                            <span class="notification-date">
                                <time datetime="2004-07-24T18:18" class="entry-date updated">Yesterday at
                                    8:10pm</time>
                                <i><img data-src="{{ asset('app-asset/images/d-tick.png') }}" alt=""
                                        class="lazy" loading="lazy"></i>
                            </span>
                        </div>
                    </li>
                    <li class="me">
                    ...
                    <li class="you">
                        <div class="chat-thumb"><img
                                data-src="{{ asset('app-asset/images/resources/chatlist2.jpg') }}" alt=""
                                class="lazy" loading="lazy"></div>
                        <div class="notification-event">
                            <span class="chat-message-item">
                                Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the
                ...
                <form class="text-box">
                    ...
                    <div class="add-smiles">
                        <span><img data-src="{{ asset('app-asset/images/smiles/happy-3.png') }}" alt=""
                                class="lazy" loading="lazy"></span>
                    </div>
                    <div class="smiles-bunch">
                        <i><img data-src="{{ asset('app-asset/images/smiles/thumb.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/angry-1.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/angry.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/bored-1.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/confused-1.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/wink.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/weep.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/tongue-out.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/suspicious.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/crying-1.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/crying.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/embarrassed.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/emoticons.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                        <i><img data-src="{{ asset('app-asset/images/smiles/happy-2.png') }}" alt=""
                                class="lazy" loading="lazy"></i>
                    </div>
                    ...
                    <div class="row merged">
                        <div class="col-lg-9">
                            <div class="pop-image">
                                <div class="pop-item">
                                    ...
                                    <figure><img data-src="{{ asset('app-asset/images/resources/blog-detail.jpg') }}"
                                            alt="" class="lazy" loading="lazy"></figure>
                                    <div class="stat-tools">
                                        <div class="box">
                        ...
                        <div class="col-lg-3">
                            <div class="commentbar">
                                <div class="user">
                                    <figure><img data-src="{{ asset('app-asset/images/resources/user1.jpg') }}"
                                            alt="" class="lazy" loading="lazy"></figure>
                                ...
                                <div class="we-video-info">
                                    ...
                                    <div class="users-thumb-list">
                                        <a href="#" title="" data-toggle="tooltip"
                                            ...
                                            <img data-src="{{ asset('app-asset/images/resources/userlist-1.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </a>
                                        <a href="#" title="" data-toggle="tooltip"
                                            data-original-title="frank">
                                            <img data-src="{{ asset('app-asset/images/resources/userlist-2.jpg') }}"
                                                alt="" class="lazy" loading="lazy">
                                        </a>
                                        <a href="#" title="" data-toggle="tooltip"
...
//for profile id verification alert ....................................
 document.addEventListener('DOMContentLoaded', function() {
    // Set a timer to dismiss the alert after 30 seconds
    setTimeout(function() {
        // Select the alert element by its ID
        var alertElement = document.getElementById('profile-alert');
        if (alertElement) {
