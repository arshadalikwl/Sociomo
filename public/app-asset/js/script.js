...
$(window).on('load', function () {
	...
	$('.alert-btn').on('click', function () {
		$('.profile-alert').addClass('profile-closed');
		// return false;
	});
	...
	// daysOutput.innerHTML = rangeslider.value;
	// priceOutput.innerHTML = getPrice(rangeslider.value);
	
	// rangeslider.oninput = function() {
	//   daysOutput.innerHTML = this.value;
	//   priceOutput.innerHTML = getPrice(this.value);
	// }
	
	// function getPrice(days) {
	  // calculate price based on days, e.g., 100 per day
	//   return days * 100;
	// }
...
jQuery(document).ready(function ($) {
	...
	$('.boost-card-btn').click(function () {
		$('.boost-card').addClass('boost-card-active');
	});
	$('.boost-close-btn').click(function () {
		$('.boost-card').removeClass('boost-card-active');
	});
	...
	// social-form-link
	$('.social-form-link').click(function () {
		$(this).addClass('social-form-link-active');
	});
